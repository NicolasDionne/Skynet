...
/**
 * Classe qui permet d'ajouter des paramètres de rotation à un objet; c'est à
 * dire, un angle de rotation, une vélocité angulaire, et une accélération
 * angulaire.
 */
...
public class RotationParameters {
	...
	/**
	 * Constructeur de paramètres de rotations. Donne une vélocité angulaire,
	 * une accélération angulaire et un angle de rotation.
	 *
	 * @param velocityP
	...
	/**
	 * Ajuste l'angle de rotation selon la vélocité angulaire
	 */
